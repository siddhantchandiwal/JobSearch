	...
	<div class="container">
		<div class="row">
			<div class="col-lg-9 col-md-12">
				...
				<form:form action="${contextPath}/Candidate/candidatelogin.htm" commandName="user" method="post" class="form-horizontal" role="form" onsubmit="return validate()">
						...
						<p class="col-sm-5 control-label" ><a href="${contextPath}/SignUp.htm" >Register here</a></p>
						<p>
