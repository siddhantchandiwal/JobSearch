...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand active" href="JobSearchMain.htm"></a>
    </div>
    	<ul class="nav navbar-nav">
        <li class="active"><a href="UserProfile.htm">View Profile</a></li>
     	 <li class="active"><a href="ViewJobs.htm">Search Jobs</a></li>
     	 <li class="active"><a href="ViewJobs.htm">Application Status</a></li> 
